(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["EasyFetch"] = factory();
	else
		root["EasyFetch"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.JsonFetch = exports.EasyFetch = undefined;
	...
	var EasyFetch = exports.EasyFetch = function () {
	    function EasyFetch(url) {
	        _classCallCheck(this, EasyFetch);
	    ...
	    _createClass(EasyFetch, [{
	        ...
	        key: 'basicAuth',
	        value: function basicAuth(login, password) {
	        ...
	        value: function _checkResponseStatus(response) {
	        ...
	        value: function _fetch(method, body) {
	            return (0, _isomorphicFetch2.default)(this.url + this._buildQueryParams(), _extends({}, this.options, { method: method, headers: this.headers, body: body })).then(this._checkResponseStatus);
	        }
	    }, {
	        key: 'head',
	        value: function head() {
